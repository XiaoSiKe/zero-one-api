...
const jobPolicies = {
  ...
  'zero-one-ci.yml': {
    ...
    console: [20, [
      ...
      'run: test -z "$(git status --porcelain --untracked-files=all -- deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v1 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v2 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v3 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v4 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v5 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v6 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v7 deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v8 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v1 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v2 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v3 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v4 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v5 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v6 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v7 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v8 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v9 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v10 deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v11 deploy/zero-one/recovered-frontend/console/assets/online-image-v7 deploy/zero-one/recovered-frontend/console/assets/online-image-v8 deploy/zero-one/recovered-frontend/console/assets/online-image-v9 deploy/zero-one/recovered-frontend/console/assets/online-image-v10 deploy/zero-one/recovered-frontend/console/assets/online-image-v11 deploy/zero-one/recovered-frontend/console/assets/online-image-v12 deploy/zero-one/recovered-frontend/console/assets/online-image-v13 deploy/zero-one/recovered-frontend/console/assets/online-image-v14 deploy/zero-one/recovered-frontend/console/assets/online-image-v15 deploy/zero-one/recovered-frontend/console/assets/online-image-v16 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v1 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v2 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v3 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v4 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v5 deploy/zero-one/recovered-frontend/console/assets/password-recovery-v6 deploy/zero-one/recovered-frontend/console/assets/shared-immutable)"',
      'run: test -z "$(git status --porcelain --untracked-files=all -- deploy/zero-one/recovered-frontend/console/assets/cn-provider-admin-v9)"',
    ]],
