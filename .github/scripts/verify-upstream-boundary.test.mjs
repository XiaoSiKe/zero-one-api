...
test('allows named immutable exceptions while adjacent seam files still fail', () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        name: 'public-capabilities-retired-codex-api',
        owner: 'Public Capabilities',
        path: 'frontend/src/api/codex.ts',
        immutable_path: 'frontend/src/api/',
      },
      {
        name: 'public-capabilities-retired-codex-api-test',
        owner: 'Public Capabilities',
        path: 'frontend/src/api/__tests__/codex.spec.ts',
        immutable_path: 'frontend/src/api/',
      },
      {
        name: 'public-capabilities-retired-channel-monitor-v2-api',
        owner: 'Public Capabilities',
        path: 'frontend/src/api/channelMonitorV2.ts',
        immutable_path: 'frontend/src/api/',
      },
      {
