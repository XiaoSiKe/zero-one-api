...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldRateMultiplier, usagelog.FieldAccountRateMultiplier, usagelog.FieldUpstreamRateMultiplier:
	...
	for i := range columns {
		...
		case usagelog.FieldUpstreamRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				...
				_m.UpstreamRateMultiplier = new(float64)
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.UpstreamRateMultiplier; v != nil {
