...
type AdminUser struct {
	...
	AgentValue     *float64   `json:"agent_value,omitempty"`
	ExclusiveAgent *bool      `json:"exclusive_agent,omitempty"`
...
// list when the compact query parameter is enabled. It contains the fields used
