...
const apiKeyAuthSnapshotVersion = 24 // v24: model allowlist; preserves group pricing and policy isolation
...
func cloneAPIKeyAuthModelAllowlist(value GroupModelAllowlist) GroupModelAllowlist {
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ModelAllowlist:                  cloneAPIKeyAuthModelAllowlist(apiKey.Group.ModelAllowlist),
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ModelAllowlist:                  cloneAPIKeyAuthModelAllowlist(snapshot.Group.ModelAllowlist),
