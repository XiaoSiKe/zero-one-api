...
export function verifyOnlineImageConsole(consoleDir) {
  ...
  const adapterImport = 'import("/assets/online-image-v15/online-image.js")'
  const shellImport = 'import("/assets/cn-provider-shell-v8/index-9xJBhx8B.js")'
  ...
  const shell = read(
    resolve(consoleDir, 'assets/cn-provider-shell-v8/index-9xJBhx8B.js'),
  ...
  const adapterDirectory = resolve(consoleDir, 'assets/online-image-v15')
  const entry = read(resolve(adapterDirectory, 'online-image.js'), 'Online image route adapter')
  requireMarkers(entry, ['/assets/online-image-v15/online-image.css'], 'Online image stylesheet namespace')
  ...
  return {
    route: '/images',
    module: '/assets/online-image-v15/online-image.js',
    stylesheet: '/assets/online-image-v15/online-image.css',
  }
}
