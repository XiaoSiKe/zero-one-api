...
export function verifyOnlineImageConsole(consoleDir) {
  ...
  const adapterDirectory = resolve(consoleDir, 'assets/online-image-v17')
  const entry = read(resolve(adapterDirectory, 'online-image.js'), 'Online image route adapter')
  requireMarkers(entry, ['/assets/online-image-v17/online-image.css'], 'Online image stylesheet namespace')
  ...
  return {
    route: '/images',
    module: '/assets/online-image-v17/online-image.js',
    stylesheet: '/assets/online-image-v17/online-image.css',
  }
}
