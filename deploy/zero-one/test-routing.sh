...
recovered_console_entry='await import("/assets/cn-provider-shell-v9/index-9xJBhx8B.js")'
recovered_console_entry_asset="$repo_root/deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v9/index-9xJBhx8B.js"
