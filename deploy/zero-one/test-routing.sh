...
recovered_online_image="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v16/online-image.js"
recovered_online_image_css="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v16/online-image.css"
...
require "$recovered_console_index" 'await import("/assets/online-image-v16/online-image.js")'
