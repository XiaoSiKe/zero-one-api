...
recovered_online_image="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v15/online-image.js"
recovered_online_image_css="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v15/online-image.css"
...
require "$recovered_console_index" 'await import("/assets/zero-one-header-custom-menu-v1.js?v=27")'
forbid "$recovered_console_index" '/assets/zero-one-header-custom-menu-v1.js?v=26'
...
require "$recovered_console_index" 'await import("/assets/online-image-v15/online-image.js")'
