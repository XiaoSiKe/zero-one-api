...
recovered_console_entry='await import("/assets/cn-provider-shell-v8/index-9xJBhx8B.js")'
recovered_console_entry_asset="$repo_root/deploy/zero-one/recovered-frontend/console/assets/cn-provider-shell-v8/index-9xJBhx8B.js"
...
recovered_online_image="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v14/online-image.js"
recovered_online_image_css="$repo_root/deploy/zero-one/recovered-frontend/console/assets/online-image-v14/online-image.css"
...
require "$recovered_console_index" 'await import("/assets/zero-one-header-custom-menu-v1.js?v=26")'
forbid "$recovered_console_index" '/assets/zero-one-header-custom-menu-v1.js?v=25'
...
require "$recovered_console_index" 'await import("/assets/online-image-v14/online-image.js")'
