...
try {
  ...
  await expect(cards).toHaveText(['$11.00', '$6.00', '$51.00', '$31.00'], { timeout: 30000 })
  ...
  await expect(cards).toHaveText(['$11.50', '$6.10', '$51.50', '$31.10'], { timeout: 30000 })
  ...
  assert.deepEqual(pending.finance, { confirmed_requests: 3, unconfirmed_requests: 1, confirmed_actual_cost: 11.5, confirmed_account_cost: 5.4, confirmed_profit: 6.1 })
