...
assert_text "$console" 'await import("/assets/zero-one-header-custom-menu-v1.js?v=26")' 'recovered console header custom-menu adapter is missing'
case "$console" in
	*'/assets/zero-one-header-custom-menu-v1.js?v=25'*)
