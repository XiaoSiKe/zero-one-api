...
// External iframe pages are an intentional Custom Page feature; executable
// resources, API calls, and top-level navigation remain local-only.
...
if (loopbackHosts.has(window.location.hostname)) {
  ...
  function externalResource(node) {
    if (node instanceof HTMLScriptElement || node instanceof HTMLImageElement) {
