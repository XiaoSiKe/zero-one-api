import { d as q, p as f, m as s, f as d, F as L, j as T, D as $, h as l, u as H, g as y, l as m, s as V } from "./cnProviderAdminLeaf-DehadpuS.js";
const _ = "openai", w = "anthropic", E = "gemini", C = "grok", M = "antigravity", D = "kimi", A = "zhipu", I = "deepseek", O = "minimax", R = "opencode_go", d0 = "https://api.x.ai", i0 = "grok-4.5", c0 = "https://api.moonshot.cn", l0 = "https://open.bigmodel.cn", u0 = "https://api.deepseek.com", g0 = "https://api.minimaxi.com", b0 = "probe", k0 = "quota", m0 = "quota_probe", h0 = "chat_completions", p0 = "responses", B = [
  _,
  w,
  E,
  C,
  ...
  O,
  R
], x0 = "operational", y0 = 60, K = ["width", "height"], G = ["d"], f0 = /* @__PURE__ */ q({
  __name: "ProviderIcon",
  props: {
    provider: {},
    size: { default: 20 }
  ...
  setup(r) {
    const c = {
      ...
      () => (i.provider || "?").charAt(0).toUpperCase()
    );
    return (b, v) => u.value ? (s(), d("svg", {
      key: 0,
      width: r.size,
      height: r.size,
      viewBox: "0 0 24 24",
      ...
      (s(!0), d(L, null, T(u.value.paths, (k, g) => (s(), d("path", {
        key: g,
        d: k
      }, null, 8, G))), 128))
    ], 8, K)) : (s(), d("span", {
      ...
      style: $({ width: `${r.size}px`, height: `${r.size}px`, fontSize: `${Math.round(r.size * 0.5)}px` })
    }, l(h.value), 5));
  }
}), j = {
  healthy: "#3B82F6",
...
function v0(r, c = !1) {
  const i = c && N(r) !== "unknown" ? " animate-pulse" : "";
  switch (N(r)) {
    case "healthy":
      return `bg-blue-500${i}`;
    case "warning":
      return `bg-amber-500${i}`;
    case "critical":
      return `bg-red-500${i}`;
    default:
...
const Z = "bg-gray-100 text-gray-800 dark:bg-dark-700 dark:text-gray-300";
function z0() {
  const { t: r } = H();
  function c(a) {
    return r(a ? `monitorCommon.status.${a}` : "monitorCommon.status.unknown");
  }
  function i(a) {
    return Q(a);
  }
  function u(a) {
    return B.includes(a) ? r(`monitorCommon.providers.${a}`) : a || "-";
  }
  function h(a) {
    return a === "probe" || a === "quota" || a === "quota_probe" ? r(`monitorCommon.checkMode.${a}`) : a || "-";
  }
  function b(a) {
    switch (a) {
      case _:
  ...
  function v(a, n) {
    switch (a) {
      case _:
        return n ? "border-zo-signal-500 bg-zo-signal-50 text-zo-signal-700 dark:bg-zo-signal-500/15 dark:text-zo-signal-300 dark:border-zo-signal-400" : "border-gray-200 bg-white text-gray-600 hover:border-zo-signal-300 hover:text-zo-signal-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-zo-signal-500/50";
      case w:
        return n ? "border-zo-alert-500 bg-zo-alert-50 text-zo-alert-700 dark:bg-zo-alert-500/15 dark:text-zo-alert-300 dark:border-zo-alert-400" : "border-gray-200 bg-white text-gray-600 hover:border-zo-alert-300 hover:text-zo-alert-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-zo-alert-500/50";
      case E:
        return n ? "border-sky-500 bg-sky-50 text-sky-700 dark:bg-sky-500/15 dark:text-sky-300 dark:border-sky-400" : "border-gray-200 bg-white text-gray-600 hover:border-sky-300 hover:text-sky-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-sky-500/50";
      case C:
        return n ? "border-zinc-500 bg-zinc-50 text-zinc-800 dark:bg-zinc-500/15 dark:text-zinc-200 dark:border-zinc-400" : "border-gray-200 bg-white text-gray-600 hover:border-zinc-400 hover:text-zinc-800 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-zinc-500/50";
      case M:
        return n ? "border-purple-500 bg-purple-50 text-purple-700 dark:bg-purple-500/15 dark:text-purple-300 dark:border-purple-400" : "border-gray-200 bg-white text-gray-600 hover:border-purple-300 hover:text-purple-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-purple-500/50";
      case D:
        return n ? "border-pink-500 bg-pink-50 text-pink-700 dark:bg-pink-500/15 dark:text-pink-300 dark:border-pink-400" : "border-gray-200 bg-white text-gray-600 hover:border-pink-300 hover:text-pink-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-pink-500/50";
      case A:
        return n ? "border-indigo-500 bg-indigo-50 text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-300 dark:border-indigo-400" : "border-gray-200 bg-white text-gray-600 hover:border-indigo-300 hover:text-indigo-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-indigo-500/50";
      case I:
        return n ? "border-teal-500 bg-teal-50 text-teal-700 dark:bg-teal-500/15 dark:text-teal-300 dark:border-teal-400" : "border-gray-200 bg-white text-gray-600 hover:border-teal-300 hover:text-teal-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-teal-500/50";
      case O:
        return n ? "border-rose-500 bg-rose-50 text-rose-700 dark:bg-rose-500/15 dark:text-rose-300 dark:border-rose-400" : "border-gray-200 bg-white text-gray-600 hover:border-rose-300 hover:text-rose-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-rose-500/50";
      case R:
        return n ? "border-amber-500 bg-amber-50 text-amber-800 dark:bg-amber-500/15 dark:text-amber-300 dark:border-amber-400" : "border-gray-200 bg-white text-gray-600 hover:border-amber-300 hover:text-amber-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-amber-500/50";
      default:
        return n ? "border-gray-400 bg-gray-50 text-gray-700 dark:border-dark-500 dark:bg-dark-700 dark:text-gray-200" : "border-gray-200 bg-white text-gray-600 hover:border-gray-300 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400";
    }
  }
  function k(a) {
    return a == null ? r("monitorCommon.latencyEmpty") : String(Math.round(a));
  }
  function g(a) {
    return a == null || Number.isNaN(a) ? "-" : `${a.toFixed(2)}%`;
  }
  function z(a) {
    return a.primary_status ? g(a.availability_7d) : "-";
  }
  function P(a) {
    if (!a) return r("monitorCommon.latencyEmpty");
    const n = Date.parse(a);
    if (Number.isNaN(n)) return r("monitorCommon.latencyEmpty");
    const p = Math.max(0, Math.floor((Date.now() - n) / 1e3));
    if (p < 60) return r("monitorCommon.relativeSecondsAgo", { n: p });
    const e = Math.floor(p / 60);
    if (e < 60) return r("monitorCommon.relativeMinutesAgo", { n: e });
    const t = Math.floor(e / 60);
    if (t < 24) return r("monitorCommon.relativeHoursAgo", { n: t });
    const o = Math.floor(t / 24);
    return r("monitorCommon.relativeDaysAgo", { n: o });
  }
  return {
    statusLabel: c,
    statusBadgeClass: i,
    ...
    providerPickerClass: v,
    formatLatency: k,
    formatPercent: g,
    formatAvailability: z,
    formatRelativeTime: P
  };
}
function _0(r) {
  if (r == null || Number.isNaN(r)) return;
  const c = Math.max(0, Math.min(100, r));
  return X(c >= 80 ? "healthy" : c >= 50 ? "warning" : "critical");
}
function w0(r) {
  switch (r) {
    case _:
...
}, W = { class: "rounded bg-gray-100 px-1.5 py-0.5 text-[10px] font-medium text-gray-600 dark:bg-dark-600 dark:text-gray-300" }, r0 = {
  key: 1,
  class: "space-y-1"
}, e0 = ["title"], a0 = { class: "h-1.5 w-16 shrink-0 overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600" }, t0 = ["title"], o0 = {
  key: 2,
  class: "flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[10px]"
}, n0 = ["title"], E0 = /* @__PURE__ */ q({
  __name: "MonitorQuotaView",
  props: {
    snapshot: {}
  },
  setup(r) {
    const c = r, { t: i, te: u } = H(), h = {
    ...
    function k(e) {
      ...
      if (!e.label) return t;
      const o = b[e.label];
      return `${o && u(o) ? i(o) : e.label}/${t}`;
    }
    const g = f(
      () => {
        var e;
        return (((e = c.snapshot) == null ? void 0 : e.tiers) || []).map((t, o) => ({
          key: `${t.window}-${t.label || ""}-${o}`,
          label: k(t),
          title: k(t),
          tier: t
        }));
      ...
      var t;
      const e = c.snapshot;
      return e ? (t = e.balances) != null && t.length ? e.balances : e.balance != null ? [{ currency: e.currency || "?", balance: e.balance }] : [] : [];
    }), P = f(() => {
      var t;
      const e = ((t = c.snapshot) == null ? void 0 : t.error) || i("monitorCommon.quota.unavailable");
      return e.length > 48 ? `${e.slice(0, 48)}…` : e;
    }), a = (e) => e >= 90 ? "bg-red-500" : e >= 75 ? "bg-amber-500" : "bg-emerald-500", n = (e) => e >= 90 ? "text-red-600 dark:text-red-400" : e >= 75 ? "text-amber-600 dark:text-amber-400" : "text-emerald-600 dark:text-emerald-400", p = (e) => {
      const t = new Date(e);
      if (isNaN(t.getTime())) return e;
      const o = Date.now(), x = t.getTime() - o;
      if (x <= 0) return i("monitorCommon.quota.resetSoon");
      if (x < 36e5) return `${Math.max(1, Math.round(x / 6e4))}m`;
      const S = Math.round(x / 36e5);
      if (S < 48) return `${S}h`;
      const F = String(t.getMonth() + 1).padStart(2, "0"), U = String(t.getDate()).padStart(2, "0");
      return `${F}-${U}`;
    };
    return (e, t) => r.snapshot ? (s(), d("div", Y, [
      r.snapshot.plan_level ? (s(), d("div", J, [
        y("span", W, l(r.snapshot.plan_level), 1)
      ])) : m("", !0),
      r.snapshot.success && g.value.length ? (s(), d("div", r0, [
        (s(!0), d(L, null, T(g.value, (o) => (s(), d("div", {
          key: o.key,
          ...
          y("div", a0, [
            y("div", {
              class: V(["h-full rounded-full transition-all", a(o.tier.used_percent)]),
              style: $({ width: `${Math.min(100, Math.max(0, o.tier.used_percent))}%` })
            }, null, 6)
          ]),
          y("span", {
            class: V(["shrink-0 font-medium", n(o.tier.used_percent)])
          }, l(Math.round(o.tier.used_percent)) + "% ", 3),
          o.tier.reset_at ? (s(), d("span", {
            key: 0,
            class: "truncate text-gray-400 dark:text-gray-500",
            title: o.tier.reset_at
          }, " · " + l(p(o.tier.reset_at)), 9, t0)) : m("", !0)
        ]))), 128))
      ])) : m("", !0),
      r.snapshot.success && z.value.length ? (s(), d("div", o0, [
        (s(!0), d(L, null, T(z.value, (o) => (s(), d("span", {
          key: o.currency,
          class: V(["font-medium", o.balance <= 0 ? "text-red-600 dark:text-red-400" : "text-gray-600 dark:text-gray-300"])
        }, l(o.balance.toFixed(2)) + " " + l(o.currency), 3))), 128))
      ])) : m("", !0),
      r.snapshot.success ? m("", !0) : (s(), d("div", {
        key: 3,
