import { d as u, r as m, c as d, o as f, f as s, s as t, J as r, l as v, g as l, m as o, B as z, p } from "./cnProviderAdminLeaf-DehadpuS.js";
const k = {
  key: 0,
  ...
  key: 1,
  class: "layout-section-fixed"
}, y = { class: "layout-section-scrollable" }, M = { class: "card table-scroll-container frosted-table-shell console-skin-table" }, g = {
  key: 2,
  class: "layout-section-fixed"
}, w = /* @__PURE__ */ u({
  ...
  setup(c) {
    const i = m(!1), e = () => {
      i.value = window.innerWidth <= 1024;
    };
    return d(() => {
      ...
      class: t(["table-page-layout", { "mobile-mode": i.value }])
    }, [
      n.$slots.actions ? (o(), s("div", k, [
        r(n.$slots, "actions", {}, void 0, !0)
      ])) : v("", !0),
      n.$slots.filters ? (o(), s("div", h, [
        r(n.$slots, "filters", {}, void 0, !0)
      ])) : v("", !0),
      l("div", y, [
        l("div", M, [
          r(n.$slots, "table", {}, void 0, !0)
        ])
      ]),
      n.$slots.pagination ? (o(), s("div", g, [
        r(n.$slots, "pagination", {}, void 0, !0)
      ])) : v("", !0)
    ], 2));
  }
}), V = /* @__PURE__ */ z(w, [["__scopeId", "data-v-75cc8a42"]]), x = /* @__PURE__ */ u({
  __name: "PlatformIcon",
  props: {
    platform: {},
    size: { default: "sm" }
  ...
  setup(c) {
    const i = c, e = p(() => ({
      ...
      md: "w-4 h-4",
      lg: "w-5 h-5"
    })[i.size] + " flex-shrink-0");
    return (n, a) => c.platform === "anthropic" ? (o(), s("svg", {
      key: 0,
      class: t(e.value),
      viewBox: "0 0 16 16",
      fill: "currentColor"
    }, [...a[0] || (a[0] = [
      l("path", { d: "m3.127 10.604 3.135-1.76.053-.153-.053-.085H6.11l-.525-.032-1.791-.048-1.554-.065-1.505-.08-.38-.081L0 7.832l.036-.234.32-.214.455.04 1.009.069 1.513.105 1.097.064 1.626.17h.259l.036-.105-.089-.065-.068-.064-1.566-1.062-1.695-1.121-.887-.646-.48-.327-.243-.306-.104-.67.435-.48.585.04.15.04.593.456 1.267.981 1.654 1.218.242.202.097-.068.012-.049-.109-.181-.9-1.626-.96-1.655-.428-.686-.113-.411a2 2 0 0 1-.068-.484l.496-.674L4.446 0l.662.089.279.242.411.94.666 1.48 1.033 2.014.302.597.162.553.06.17h.105v-.097l.085-1.134.157-1.392.154-1.792.052-.504.25-.605.497-.327.387.186.319.456-.045.294-.19 1.23-.37 1.93-.243 1.29h.142l.161-.16.654-.868 1.097-1.372.484-.545.565-.601.363-.287h.686l.505.751-.226.775-.707.895-.585.759-.839 1.13-.524.904.048.072.125-.012 1.897-.403 1.024-.186 1.223-.21.553.258.06.263-.218.536-1.307.323-1.533.307-2.284.54-.028.02.032.04 1.029.098.44.024h1.077l2.005.15.525.346.315.424-.053.323-.807.411-3.631-.863-.872-.218h-.12v.073l.726.71 1.331 1.202 1.667 1.55.084.383-.214.302-.226-.032-1.464-1.101-.565-.497-1.28-1.077h-.084v.113l.295.432 1.557 2.34.08.718-.112.234-.404.141-.444-.08-.911-1.28-.94-1.44-.759-1.291-.093.053-.448 4.821-.21.246-.484.186-.403-.307-.214-.496.214-.98.258-1.28.21-1.016.19-1.263.112-.42-.008-.028-.092.012-.953 1.307-1.448 1.957-1.146 1.227-.274.109-.477-.247.045-.44.266-.39 1.586-2.018.956-1.25.617-.723-.004-.105h-.036l-4.212 2.736-.75.096-.324-.302.04-.496.154-.162 1.267-.871z" }, null, -1)
    ])], 2)) : c.platform === "openai" ? (o(), s("svg", {
      key: 1,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    }, [...a[1] || (a[1] = [
      l("path", { d: "M22.282 9.821a5.985 5.985 0 0 0-.516-4.91 6.046 6.046 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a5.985 5.985 0 0 0-3.998 2.9 6.046 6.046 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 19.95a4.5 4.5 0 0 1-6.14-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.076.076 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667zm2.01-3.023l-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L9.409 9.23V6.897a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l-2.02-1.164a.08.08 0 0 1-.038-.057V6.075a4.5 4.5 0 0 1 7.375-3.453l-.142.08L8.704 5.46a.795.795 0 0 0-.393.681zm1.097-2.365l2.602-1.5 2.607 1.5v2.999l-2.597 1.5-2.607-1.5z" }, null, -1)
    ])], 2)) : c.platform === "gemini" ? (o(), s("svg", {
      key: 2,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    }, [...a[2] || (a[2] = [
      l("path", { d: "M12 2l1.89 7.2L21 12l-7.11 2.8L12 22l-1.89-7.2L3 12l7.11-2.8L12 2z" }, null, -1)
    ])], 2)) : c.platform === "antigravity" ? (o(), s("svg", {
      key: 3,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    }, [...a[3] || (a[3] = [
      l("path", { d: "M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" }, null, -1)
    ])], 2)) : c.platform === "grok" ? (o(), s("svg", {
      key: 4,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    ...
    ])], 2)) : c.platform === "kimi" ? (o(), s("svg", {
      key: 5,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    }, [...a[5] || (a[5] = [
      l("path", { d: "M21.765.351C22.998.351 24 1.353 24 2.586S22.998 4.82 21.765 4.82h-1.974c-.15 0-.26-.12-.26-.26V2.586A2.237 2.237 0 0 1 21.765.35M9.41 13.388l8.447-8.377c.16-.16.07-.471-.14-.471h-4.55s-.1.02-.14.06l-9.099 9.029c-.14.14-.35.02-.35-.21V4.81c0-.15-.1-.27-.221-.27H.22c-.12 0-.22.12-.22.27v18.57c0 .15.1.27.22.27h3.137c.12 0 .22-.12.22-.27v-3.79c0-.08.03-.16.08-.21l2.826-2.796c.07-.07.16-.08.241-.03l7.546 5.551a8.9 8.9 0 0 0 4.018 1.493c.12.01.23-.11.23-.27V19.76c0-.14-.08-.25-.19-.26a5.8 5.8 0 0 1-2.355-.942l-6.533-4.73c-.14-.09-.15-.32-.03-.441" }, null, -1)
    ])], 2)) : c.platform === "zhipu" ? (o(), s("svg", {
      key: 6,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
