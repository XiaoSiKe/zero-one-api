import { e as u, r as m, c as d, o as f, g as s, s as t, J as r, m as v, h as l, n as c, B as z, d as h } from "./cnProviderAdminLeaf-CHNemIo-.js";
const k = {
  key: 0,
  ...
  key: 1,
  class: "layout-section-fixed"
}, y = { class: "layout-section-scrollable" }, M = { class: "card table-scroll-container frosted-table-shell console-skin-table" }, w = {
  key: 2,
  class: "layout-section-fixed"
}, g = /* @__PURE__ */ u({
  ...
  setup(o) {
    ...
    return d(() => {
      ...
      n.$slots.actions ? (c(), s("div", k, [
        r(n.$slots, "actions", {}, void 0, !0)
      ])) : v("", !0),
      n.$slots.filters ? (c(), s("div", p, [
      ...
      n.$slots.pagination ? (c(), s("div", w, [
        r(n.$slots, "pagination", {}, void 0, !0)
      ])) : v("", !0)
    ], 2));
  }
}), V = /* @__PURE__ */ z(g, [["__scopeId", "data-v-75cc8a42"]]), x = /* @__PURE__ */ u({
  __name: "PlatformIcon",
  props: {
    platform: {},
    size: { default: "sm" }
  ...
  setup(o) {
    ...
    return (n, a) => o.platform === "anthropic" ? (c(), s("svg", {
      key: 0,
      class: t(e.value),
      viewBox: "0 0 16 16",
      fill: "currentColor"
    ...
    ])], 2)) : o.platform === "antigravity" ? (c(), s("svg", {
      key: 3,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "currentColor"
    ...
    ])], 2)) : o.platform === "composite" ? (c(), s("svg", {
      key: 9,
      class: t(e.value),
      viewBox: "0 0 24 24",
      fill: "none",
