import { e as mt, u as pt, d as S, f as gt, n as r, g as l, h as t, q as p, i as o, m as c, s as O, F as U, l as x, j as n, B as bt, r as m, b as W, c as Jt, o as Xt, $ as ot, v as y, A as N, _ as k, k as de, D as $e, x as xe, y as he, z as Ue, T as Zt, M as es } from "./cnProviderAdminLeaf-CHNemIo-.js";
import { g as ts, G as ss, P as as, D as is, S as _e, _ as rt, d as Fe, b as $ } from "./platforms-PDcpwPD4.js";
import { d as lt } from "./format-Dqf1XZPq.js";
import { T as ns } from "./PlatformIcon.vue_vue_type_script_setup_true_lang-D5-_2Rvn.js";
import { _ as os } from "./EmptyState.vue_vue_type_script_setup_true_lang-7SE9Jis_.js";
import { f as rs, s as ls, _ as je } from "./GroupBadge.vue_vue_type_script_setup_true_lang-BMIXgIqy.js";
  ...
  setup(g) {
    const { t: e } = pt(), d = g, h = S(() => d.userRateMultiplier !== null && d.userRateMultiplier !== void 0 && d.rateMultiplier !== void 0 && d.userRateMultiplier !== d.rateMultiplier), z = gt(), v = S(() => !!(d.peakRateEnabled && d.peakStart && d.peakEnd)), L = S(() => {
      ...
      return rs(
        ...
        ls((Q = z.cachedPublicSettings) == null ? void 0 : Q.server_utc_offset)
      );
...
const ks = { class: "flex flex-wrap items-start justify-between gap-4" }, ws = { class: "flex flex-1 flex-wrap items-center gap-3" }, Cs = {
  ...
  key: 1,
  class: "px-4 py-3 text-sm text-gray-500 dark:text-gray-400"
}, Es = ["onClick"], Rs = { class: "font-medium text-gray-900 dark:text-white" }, $s = { class: "ml-2 text-gray-500 dark:text-gray-400" }, Us = { class: "w-full sm:w-40" }, Fs = { class: "w-full sm:w-48" }, js = { class: "w-full sm:w-40" }, Vs = { class: "ml-auto flex flex-wrap items-center justify-end gap-3" }, As = ["disabled", "title"], Ps = ["title"], Is = { class: "hidden md:inline" }, Ns = {
  key: 0,
...
}, Os = { class: "p-2" }, Ls = { class: "mb-2 border-b border-gray-200 pb-2 dark:border-dark-700" }, Bs = { class: "px-3 py-1 text-xs font-medium text-gray-500 dark:text-gray-400" }, Qs = ["onClick"], Gs = ["title"], qs = { class: "flex items-center gap-2" }, Hs = { class: "flex h-8 w-8 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900/30" }, Ks = { class: "text-sm font-medium text-primary-700 dark:text-primary-300" }, Ws = {
  key: 1,
...
}, ha = { class: "flex items-center gap-1" }, _a = ["onClick"], ka = { class: "text-xs" }, wa = ["onClick", "disabled"], Ca = { class: "text-xs" }, Sa = ["onClick"], za = { class: "text-xs" }, Ma = ["onClick"], Ta = { class: "text-xs" }, Da = { class: "input-label" }, Ea = {
  class: "relative",
  ...
  key: 1,
  class: "text-gray-400"
}, Na = { class: "input-hint" }, Oa = { class: "input-label" }, La = { class: "input-hint" }, Ba = { class: "flex justify-end gap-3" }, Qa = ["disabled"], Ga = {
  key: 0,
  class: "-ml-1 mr-2 h-4 w-4 animate-spin",
  fill: "none",
  viewBox: "0 0 24 24"
}, qa = { class: "rounded-lg bg-gray-50 p-4 dark:bg-dark-700" }, Ha = { class: "text-sm text-gray-600 dark:text-gray-400" }, Ka = { class: "font-medium text-gray-900 dark:text-white" }, Wa = { class: "mt-1 text-sm text-gray-600 dark:text-gray-400" }, Ya = { class: "font-medium text-gray-900 dark:text-white" }, Ja = {
  key: 0,
  ...
  setup(g) {
    const { t: e } = pt(), d = gt(), h = m(!1), z = S(() => [
      ...
      () => Q.value.filter((a) => a.key !== "user" && a.key !== "actions")
    ), D = W(/* @__PURE__ */ new Set()), Ae = [], yt = () => {
      try {
        const a = localStorage.getItem(ct);
        a ? JSON.parse(a).forEach((u) => D.add(u)) : Ae.forEach((s) => D.add(s));
      } catch (a) {
        console.error("Failed to load saved columns:", a), Ae.forEach((s) => D.add(s));
      }
    }, vt = () => {
      try {
      ...
      D.has(a) ? D.delete(a) : D.add(a), vt();
    }, xt = (a) => !D.has(a), ht = S(
      () => Q.value.filter(
        (a) => a.key === "user" || a.key === "actions" || !D.has(a.key)
      )
    ...
    let G = null;
    const V = m(""), A = m([]), Ce = m(!1), X = m(!1), q = m(null);
    let Z = null;
    ...
    const _ = W({
      ...
      total: 0,
      pages: 0
    }), ge = m(!1), ze = m(!1), be = m(!1), ye = m(!1), ve = m(!1), E = m(!1), H = m(null), fe = m(!1), C = m(null), se = m(null), ae = m(null), f = W({
      user_id: null,
      group_id: null,
      validity_days: 30
    }), ie = W({
      ...
      if (q.value && a !== q.value.email && (q.value = null, _.user_id = null, K()), !a) {
        A.value = [];
        return;
      }
      Ce.value = !0;
      ...
      q.value = a, V.value = a.email, X.value = !1, _.user_id = a.id, K();
    }, Dt = () => {
      q.value = null, V.value = "", A.value = [], X.value = !1, _.user_id = null, K();
    }, Et = () => {
      ...
      H.value = a, ve.value = !0;
    }, Gt = async () => {
      var a, s;
      if (H.value && !fe.value) {
        fe.value = !0;
        try {
          await $.subscriptions.resetQuota(H.value.id, { daily: !0, weekly: !0, monthly: !0 }), d.showSuccess(e("admin.subscriptions.quotaResetSuccess")), ve.value = !1, H.value = null, await M();
        } catch (u) {
      ...
      const s = Ie(a);
      return s !== null && s <= 7;
    }, De = (a, s) => !s || s === 0 ? "0%" : `${Math.min((a ?? 0) / s * 100, 100)}%`, Ee = (a, s) => {
    ...
    return Jt(() => {
      ...
      return r(), l(U, null, [
        p(ns, null, {
              ...
              t("div", ws, [
                t("div", Cs, [
                  ...
                  X.value && (A.value.length > 0 || V.value) ? (r(), l("div", Ms, [
                    Ce.value ? (r(), l("div", Ts, o(n(e)("common.loading")), 1)) : A.value.length === 0 && V.value ? (r(), l("div", Ds, o(n(e)("common.noOptionsFound")), 1)) : c("", !0),
          ...
          table: y(() => [
            p(is, {
              ...
              "cell-usage": y(({ row: i }) => {
                var b, R, oe, re, le, ue, Ge, qe, He, Ke, We, Ye, Je, Xe, Ze, et, tt, st, at, it, nt;
                return [
                  t("div", Ys, [
                    (b = i.group) != null && b.daily_limit_usd ? (r(), l("div", Js, [
                      t("div", Xs, [
                        ...
                        t("div", ea, [
                          t("div", {
                            class: O(["h-1.5 rounded-full transition-all", Ee(i.daily_usage_usd, (R = i.group) == null ? void 0 : R.daily_limit_usd)]),
                            style: $e({
                              width: De(i.daily_usage_usd, (oe = i.group) == null ? void 0 : oe.daily_limit_usd)
                            })
                          }, null, 6)
                        ]),
                        t("span", ta, [
                    ...
                    (Ge = i.group) != null && Ge.weekly_limit_usd ? (r(), l("div", aa, [
                      t("div", ia, [
                        ...
                        t("div", oa, [
                          t("div", {
                            class: O(["h-1.5 rounded-full transition-all", Ee(i.weekly_usage_usd, (qe = i.group) == null ? void 0 : qe.weekly_limit_usd)]),
                            style: $e({
                              width: De(i.weekly_usage_usd, (He = i.group) == null ? void 0 : He.weekly_limit_usd)
                            })
                          }, null, 6)
                        ]),
                        t("span", ra, [
                    ...
                    (Je = i.group) != null && Je.monthly_limit_usd ? (r(), l("div", ua, [
                      t("div", da, [
                        ...
                        t("div", ma, [
                          t("div", {
                            class: O(["h-1.5 rounded-full transition-all", Ee(i.monthly_usage_usd, (Xe = i.group) == null ? void 0 : Xe.monthly_limit_usd)]),
                            style: $e({
                              width: De(i.monthly_usage_usd, (Ze = i.group) == null ? void 0 : Ze.monthly_limit_usd)
                            })
                          }, null, 6)
                        ]),
                        t("span", pa, [
              ...
              "cell-expires_at": y(({ value: i }) => [
                i ? (r(), l("div", va, [
                  t("span", {
                    class: O([
                      "text-sm",
                      Ht(i) ? "text-zo-alert-600 dark:text-zo-alert-400" : "text-gray-700 dark:text-gray-300"
                    ])
                  }, o(n(lt)(i)), 3),
                  (r(!0), l(U, null, de([qt(i)], (b) => (r(), l(U, {
                    key: b ?? "expired"
                  }, [
                ...
                return [
                  t("div", ha, [
                    ...
                    i.status === "active" ? (r(), l("button", {
                      key: 1,
                      onClick: (R) => Qt(i),
                      disabled: fe.value && ((b = H.value) == null ? void 0 : b.id) === i.id,
          ...
          footer: y(() => [
            t("div", Ba, [
              ...
              t("button", {
                ...
                x(" " + o(E.value ? n(e)("admin.subscriptions.assigning") : n(e)("admin.subscriptions.assign")), 1)
              ], 8, Qa)
            ])
          ]),
          default: y(() => [
            t("form", {
              ...
              t("div", null, [
                t("label", Da, o(n(e)("admin.subscriptions.form.user")), 1),
                t("div", Ea, [
                  xe(t("input", {
          ...
          footer: y(() => [
            C.value ? (r(), l("div", ai, [
              ...
              t("button", {
                ...
                disabled: E.value,
                class: "btn btn-primary"
              }, o(E.value ? n(e)("admin.subscriptions.adjusting") : n(e)("admin.subscriptions.adjust")), 9, ii)
            ])) : c("", !0)
          ]),
          default: y(() => {
            var i;
        ...
        p(Fe, {
          ...
          message: n(e)("admin.subscriptions.resetQuotaConfirm", { user: (Qe = (Be = H.value) == null ? void 0 : Be.user) == null ? void 0 : Qe.email }),
