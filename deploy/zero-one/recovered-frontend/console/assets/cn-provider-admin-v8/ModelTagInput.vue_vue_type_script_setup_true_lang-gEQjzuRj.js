import { e as D, u as F, r as P, n as h, g as b, h as _, F as V, k as O, s as q, j as w, l as U, i as z, q as B, _ as K, x as W, y as R, E as T, z as y } from "./cnProviderAdminLeaf-CHNemIo-.js";
    ...
    return (l, u) => (h(), b("div", null, [
      _("div", te, [
        (h(!0), b(V, null, O(e.models, (d, f) => (h(), b("span", {
          key: f,
          class: q(["inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-sm", w(ee)(n.platform || "")])
        }, [
          U(z(d) + " ", 1),
          _("button", {
            type: "button",
      ...
      _("p", ie, z(w(r)("admin.channels.form.modelInputHint", "Press Enter to add, supports paste for batch import.")), 1)
    ]));
  }
});
export {
