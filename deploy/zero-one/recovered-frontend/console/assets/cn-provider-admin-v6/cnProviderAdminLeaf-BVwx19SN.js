...
const h2 = /* @__PURE__ */ mu("auth", () => {
  ...
  channels: () => import("./ChannelsView-KtzT-VxP.js"),
  "channel-monitor": () => import("./ChannelMonitorView-DzxNfUI1.js"),
  ops: () => import("./OpsDashboard-CAXKEWcH.js"),
  subscriptions: () => import("./SubscriptionsView-D-uhWS_c.js")
};
function p2() {
  var t, n, r;
