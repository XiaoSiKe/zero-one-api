...
function R() {
  ...
  const t = "/assets/cn-provider-admin-v6/cn-provider-admin.css", n = document.getElementById(E);
...
async function T(t, n) {
  ...
  let o = null;
  try {
    if (o = await (await import("./cnProviderAdminLeaf-BVwx19SN.js").then((c) => c.a8)).prepareCNProviderSurface(t, h()), a !== f || v() !== t || !n.isConnected || !e.isConnected || e.parentElement !== n) {
