...
function L() {
  ...
  e.id = b, e.rel = "stylesheet", e.href = "/assets/online-image-v7/online-image.css", document.head.append(e);
}
function C(e, t) {
...
async function z(e, t) {
  ...
  i == null || i.unmount(), i = null, g = null, t.replaceChildren(), s = (async () => {
    let o = null;
    try {
      if (o = await (await import("./onlineImageLeaf-CnXoNtqy.js")).prepareOnlineImageSurface(h()), n !== d || window.location.pathname !== r || !e.isConnected || !t.isConnected || t.parentElement !== e) {
