...
async function T(t, n) {
  ...
  let o = null;
  try {
    if (o = await (await import("./cnProviderAdminLeaf-BPO9X3xc.js").then((c) => c.a8)).prepareCNProviderSurface(t, h()), a !== f || v() !== t || !n.isConnected || !e.isConnected || e.parentElement !== n) {
