...
5.6.0.0/16`,
  ...
  usage: {
    ...
    accountCostPending: "Missing cost evidence",
    accountCostUnsupportedScope: "Unsupported billing scope",
    accountCostMissingEvidence: "Upstream evidence was not saved when this request occurred",
    accountCostUnknownSummary: "{unsupported} unsupported, {missing} missing evidence",
    hideAccountCost: "Hide account cost",
    showAccountCost: "Show account cost",
    accountCostStatus: "Account cost status",
    accountCostConfirmed: "Confirmed",
  ...
  channelMonitorV2: {
    ...
    bootstrap: {
      ...
      description: "On first enable, passive aggregation silently fills the 90m, 24h, 7d, and 30d windows in the background. All ranges become complete once this finishes.",
    ...
    groupBy: {
      ...
      platformGroupModel: "Platform / Group / Model"
    },
    ...
    matrix: {
      ...
      description: "Each row is a channel dimension and each block is an aggregate interval; hover for details",
      wheelZoom: "Scroll over blocks to zoom in (narrower range, wider blocks)",
      wheelZoomX: "Scroll over blocks to zoom in (narrower range, wider blocks)",
      dimension: "Channel dimension",
      emptyTitle: "No matrix data for the selected window",
      legendAria: "Health score legend",
      bad: "Bad",
      good: "Good",
      healthyLegend: "Healthy (≥80)",
      warningLegend: "Watch (50–79)",
      criticalLegend: "Critical (<50)",
      unknownLegend: "No traffic / insufficient samples",
      noTraffic: "No traffic in this interval",
      noTrafficAt: "{time} · no traffic",
      scoreLine: "Health score {score}",
      resetZoom: "Reset zoom"
    },
    chart: {
      title: "Availability trend",
      description: "Smoothed trend: error rate · first token P50 · cache rate",
      emptyTitle: "No trend data for the selected window",
      errorLegend: "Error rate (left axis %)",
      cacheLegend: "Cache rate (left axis %)",
      ttftLegend: "First token P50 (right axis)",
      errorDataset: "Error rate trend %",
      cacheDataset: "Cache rate trend %",
      ttftDataset: "First token trend P50 (ms)",
      percentAxis: "Rate %",
      resetZoom: "Reset zoom"
    },
    ...
    errorCategories: {
      ...
      timeout: "Timeout",
      transport_or_stream: "Transport or stream",
      upstream_forbidden: "Upstream forbidden",
      not_found: "Not found",
    ...
    settings: {
      ...
      description: "Configure passive usage aggregation dimensions (platform / model / group) and refresh cadence. Health colors and details on the user /monitor page show rates, RPM, and TPM — not absolute request volume.",
      save: "Save",
      loading: "Loading…",
      loadFailed: "Failed to load V2 config",
      saveSuccess: "V2 monitor config saved",
      saveFailed: "Failed to save V2 config",
      modeBanner: "System mode is currently {mode}. V2 minute aggregation will not run; this config can be prepared now and takes effect after switching to {modeV2}. Change mode under System Settings → Feature switches.",
      modeClosed: "Channel monitor disabled",
      modeV1: "V1 active probes",
      modeV2: "V2 passive monitoring",
      enableTitle: "Enable V2 aggregation",
      enableHint: "Applies when system mode is V2. Turning this off only stops this config’s aggregation; the system mode switch remains under Feature switches.",
      ...
      platformsHint: "Leave empty = show all real model names; when filled, only listed models get their own rows and the rest roll into “Other”",
      ...
      errorsHint: "Checked “ignore” categories are excluded from error rate and health score, but still appear greyed in the error breakdown. Unmatched errors roll into “Other”.",
      ignoredSummary: "Ignored {ignored} categories · counted in error rate {counted} categories",
      healthTitle: "Health thresholds",
      healthHint: "Controls user-facing color bands and overall score. Defaults are tolerant so small error rates or low cache do not immediately show as unhealthy.",
      fields: {
    ...
    admin: {
      descriptionV1: "System mode is V1 active probes: manage probe monitors and run checks now; V2 aggregation does not run.",
      descriptionV2: "System mode is V2 passive monitoring: configure aggregation dimensions; V1 active probes do not run.",
...
badword2`,
  ...
  channelMonitor: {
    ...
    form: {
      ...
      probeBillingWarning: "Active probing sends real generation requests upstream and may incur charges.",
      probeDailyEstimate: "At the current interval across {models} model(s): about {requests} generation requests per day.",
      quotaNoGeneration: "Quota-only mode reads account usage or balance and does not send LLM generation requests.",
...
• The invite code will be regenerated as a new system code (previously shared links will stop working)`,
    ...
    site: {
      ...
      navigation: {
        ...
        description: "Control built-in entries and choose where Model Plaza appears in the console.",
        profile: "Profile",
        profileHint: "Controls the Profile sidebar entry; the route and account menu remain available.",
        subscriptions: "My Subscriptions",
        subscriptionsHint: "Controls the My Subscriptions sidebar entry and header progress entry.",
        modelPlaza: "Model Plaza Placement",
      ...
      headerNavigation: {
        ...
        description: "Add one or more QR entries. Each header button opens its configured QR code.",
        itemLabel: "Header Entry #{n}",
        name: "Button and Dialog Title",
        namePlaceholder: "e.g. Community",
        visibility: "Visibility",
        dialogDescription: "Dialog Subtitle",
        dialogDescriptionPlaceholder: "Scan to join the community and get support",
        qrImage: "QR Code Image",
        selectQr: "Select QR Code",
        removeQr: "Remove",
        qrHint: "PNG, JPEG, or WebP, up to 300 KiB. Images are served on demand only to signed-in users.",
        qrRequired: "Select a QR image for each new header navigation entry before saving.",
    ...
    customMenu: {
      ...
      description: "Add custom iframe pages to the sidebar, header navigation, or both. Each page can choose its placement and be visible to regular users, administrators, or all signed-in users.",
      ...
      iconChoices: "Built-in SVG Icons",
      iconHint: "Choose one of the five built-in SVGs or upload a custom SVG.",
      iconPresets: {
        link: "Link",
        users: "Community",
        gift: "Gift",
      ...
      visibilityAll: "Both Regular Users and Administrators",
      placement: "Placement",
...
model not supported`,
  ...
  promptAudit: {
    ...
    events: {
      ...
      tabs: { summary: "Audit summary", risks: "Specific risks", technical: "Technical details" },
  ...
  version: {
    ...
    managedUpdateHint: "Zero One uses a custom Docker image. Upgrade it through the release workflow; the console will not overwrite the binary inside the container.",
    ...
    managedRollbackHint: "Zero One rolls back by switching the pinned image digest. Use the release workflow; the console does not replace the binary in place.",
    deployScript: "Script",
    deployDocker: "Docker",
