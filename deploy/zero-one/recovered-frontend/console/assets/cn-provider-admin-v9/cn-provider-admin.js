...
function b(t) {
  ...
  const n = t === "channel-monitor" || t === "channel-status" ? "/assets/cn-provider-admin-v9/cn-provider-admin.css" : "/assets/cn-provider-admin-v8/cn-provider-admin.css", e = document.getElementById(g);
...
async function z(t, n) {
  ...
  let r = null;
  try {
    const i = t === "channel-monitor" || t === "channel-status" ? await import("./cnProviderAdminLeaf-DOTfdkE4.js").then((p) => p.ae) : await import(
      /* @vite-ignore */
      S
    ), l = T(i);
