import { d as h, u as _, p as n, e as $, m as l, f as o, s as u, A as M, l as d, g as p, h as s, F as b, k as w } from "./cnProviderAdminLeaf-DOTfdkE4.js";
import { _ as B } from "./PlatformIcon.vue_vue_type_script_setup_true_lang-B2Zys8YY.js";
function S(t) {
...
const E = { class: "truncate" }, P = { class: "line-through opacity-50 mr-0.5" }, N = { class: "font-bold" }, V = ["title"], D = /* @__PURE__ */ h({
  ...
  setup(t) {
    const e = t, { t: i } = _(), r = n(() => e.subscriptionType === "subscription"), k = n(() => e.userRateMultiplier !== null && e.userRateMultiplier !== void 0 && e.rateMultiplier !== void 0 && e.userRateMultiplier !== e.rateMultiplier), x = $(), c = n(() => !!(e.showRate && e.peakRateEnabled && e.peakStart && e.peakEnd)), g = n(() => {
      var a;
      return C(
        {
        ...
        T((a = x.cachedPublicSettings) == null ? void 0 : a.server_utc_offset)
      );
