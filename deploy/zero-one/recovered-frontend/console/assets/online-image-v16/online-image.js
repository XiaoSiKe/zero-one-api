...
function k() {
  ...
  e.id = A, e.rel = "stylesheet", e.href = "/assets/online-image-v16/online-image.css", document.head.append(e);
}
function P(e, t) {
...
async function $(e, t) {
  ...
  r == null || r.unmount(), r = null, E = null, t.replaceChildren(), u = (async () => {
    let o = null;
    try {
      if (o = await (await import("./onlineImageLeaf-Vh2XTehD.js")).prepareOnlineImageSurface(p()), n !== m || window.location.pathname !== l || !e.isConnected || !t.isConnected || t.parentElement !== e) {
