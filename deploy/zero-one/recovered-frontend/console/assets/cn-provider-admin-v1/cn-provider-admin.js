...
async function P(e, n) {
  ...
  let o = null;
  try {
    if (o = await (await import("./cnProviderAdminLeaf-B-djDzla.js").then((c) => c.a8)).prepareCNProviderSurface(e, f()), i !== p || v() !== e || !n.isConnected || !t.isConnected || t.parentElement !== n) {
