export default {
    settings: {
      ...
      site: {
        ...
        communityQr: {
          title: '顶部交流群入口',
          description: '在控制台顶部导航显示交流群按钮，点击后展示群二维码。',
          enabled: '显示交流群入口',
          enabledHint: '保存后，已登录用户可以在顶部导航打开该二维码。',
          uploadBeforeEnable: '请先上传二维码，再启用顶部入口。',
          dialogTitle: '顶部按钮及弹窗标题',
          dialogTitlePlaceholder: '如：交流群',
          dialogDescription: '弹窗副标题',
          dialogDescriptionPlaceholder: '如：扫码加入交流群获取支持',
          image: '群二维码',
          upload: '导入二维码',
          remove: '移除',
          imageHint: '支持 PNG、JPG/JPEG 或 WebP，最大 300KB。为保证可扫描，建议上传清晰的正方形图片。',
        },
        apiBaseUrl: 'API 端点地址',
