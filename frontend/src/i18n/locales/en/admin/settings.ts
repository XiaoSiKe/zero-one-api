export default {
    settings: {
      ...
      site: {
        ...
        communityQr: {
          title: 'Header Community Entry',
          description: 'Show a Community button in the console header that opens the uploaded group QR code.',
          enabled: 'Show Community Entry',
          enabledHint: 'After saving, signed-in users can open this QR code from the console header.',
          uploadBeforeEnable: 'Upload a QR code before enabling the header entry.',
          dialogTitle: 'Header Button and Dialog Title',
          dialogTitlePlaceholder: 'e.g. Community Group',
          dialogDescription: 'Dialog Subtitle',
          dialogDescriptionPlaceholder: 'e.g. Scan to join the group and get support',
          image: 'Group QR Code',
          upload: 'Import QR Code',
          remove: 'Remove',
          imageHint: 'PNG, JPG/JPEG, or WebP. Max 300KB. Use a clear square image for reliable scanning.',
        },
