    ...
    settings: {
      ...
      site: {
        ...
        headerNavigation: {
          ...
          description: 'Add one or more custom entries to the console header in display order.',
          itemLabel: 'Header Entry #{n}',
          name: 'Entry Name',
          namePlaceholder: 'e.g. Recharge',
          visibility: 'Visibility',
          url: 'Destination URL',
          urlPlaceholder: 'https://example.com',
          empty: 'No header entries yet. Add one or more as needed.',
          hint: 'This section manages header-only entries. Sidebar and dual-placement pages remain in Custom Menu Pages below.',
