    ...
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card console-card-motion-static">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="header">
                        {{ t("admin.settings.customMenu.placementHeader") }}
                      </option>
                      <option value="both">
...
const dedicatedAffiliateSettingKeys = new Set([
  "affiliate_enabled",
  "affiliate_rebate_rate",
  "affiliate_rebate_freeze_hours",
  "affiliate_rebate_duration_days",
...
async function loadSettings() {
  ...
  try {
    ...
    for (const [key, value] of Object.entries(settings)) {
      if (
        !dedicatedAffiliateSettingKeys.has(key) &&
        value !== null &&
        value !== undefined
      ) {
    ...
    form.community_qr_image =
      typeof settings.community_qr_image === "string"
        ? settings.community_qr_image.trim()
        : "";
    form.community_qr_enabled =
      settings.community_qr_enabled === true &&
      form.community_qr_image.length > 0;
    form.community_qr_title =
      typeof settings.community_qr_title === "string" && settings.community_qr_title.trim()
        ? settings.community_qr_title.trim()
        : "交流群";
    form.community_qr_description =
      typeof settings.community_qr_description === "string"
        ? settings.community_qr_description.trim()
        : "扫码加入交流群获取支持";
